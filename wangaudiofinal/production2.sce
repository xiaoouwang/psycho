...
picture {
  ...
  text { caption = "请朗读...\n\n";font_size = 40;font_color=255,0,0;};
       ...
       duration=5000;
picture {
   text {caption = "告示出现时朗读绿色的符号\n\n此符号可能是单独的元音，比如 /O/\n\n也可能是一段包含此元音的语音，比如 /OpO/\n\n也可能是一个单词，比如 porc";font_size = 40;font_color = 255,255,255;};
   x = 0; y = 0;};
   delta_time=5000;
   duration=11500;

picture {
   text {caption = "不要再用平时习惯的发音方法
   用你在训练中学到的方法朗读
   注意将学到的成果应用到单词中";font_size = 40;font_color = 255,255,255;};
   x = 0; y = 0;};
   delta_time=11500;
   duration=6000;
}
...
array {
   ...
   text { caption = "/ata/"; font_size = 50;
       font_color = 0,255,0;}; 
   text { caption = "/aka/"; font_size = 50;
font_color = 0,255,0;}; 
   text { caption = "/afa/"; font_size = 50;
font_color = 0,255,0;}; 
   text { caption = "/asa/"; font_size = 50;
font_color = 0,255,0;}; 
} lettersa;
...
begin
	...
	training_audio_sound_recording.set_base_filename("\\\\filesrv1\\home\$\\wangxiao\\.windows\\Bureau\\wang\\apresshadowing\\e");
   main_trial.present();
system_keyboard.get_input();
...
begin
	...
	training_audio_sound_recording.set_base_filename("\\\\filesrv1\\home\$\\wangxiao\\.windows\\Bureau\\wang\\apresshadowing\\o");
   main_trial.present();
system_keyboard.get_input();
   recording_manager.stop_all(false);
i=i+1
...
begin
	...
	training_audio_sound_recording.set_base_filename("\\\\filesrv1\\home\$\\wangxiao\\.windows\\Bureau\\wang\\apresshadowing\\eu");
   main_trial.present();
system_keyboard.get_input();
recording_manager.stop_all(false);
   i=i+1
...
begin
	...
	training_audio_sound_recording.set_base_filename("\\\\filesrv1\\home\$\\wangxiao\\.windows\\Bureau\\wang\\apresshadowing\\oe");
   main_trial.present();
system_keyboard.get_input();
recording_manager.stop_all(false);
   i=i+1
...
begin
	...
	training_audio_sound_recording.set_base_filename("\\\\filesrv1\\home\$\\wangxiao\\.windows\\Bureau\\wang\\apresshadowing\\a");
   main_trial.present();
system_keyboard.get_input();
recording_manager.stop_all(false);
   i=i+1
...
begin
	...
	training_audio_sound_recording.set_base_filename("\\\\filesrv1\\home\$\\wangxiao\\.windows\\Bureau\\wang\\apresshadowing\\i");
   main_trial.present();
system_keyboard.get_input();
recording_manager.stop_all(false);
   i=i+1
...
begin
	...
	training_audio_sound_recording.set_base_filename("\\\\filesrv1\\home\$\\wangxiao\\.windows\\Bureau\\wang\\apresshadowing\\u");
   main_trial.present();
system_keyboard.get_input();
recording_manager.stop_all(false);
   i=i+1
